...
With LT SDK, you can build your own customized application with Call function. This documentary provides a guideline that demonstrates how to build and configure an in-app message and call using LT SDK.
...
[LTCallSample for Android](https://github.com/LoFTechs/LTCallSmaple-Android-Kotlin.git) 1.0.0 or higher.
...
- You can **clone** the project from the [LTCallSample repository](https://github.com/LoFTechs/LTCallSmaple-Android-Kotlin.git).

```
// Clone this repository
git clone git@github.com:LoFTechs/LTCallSmaple-Android-Kotlin.git

// Move to the LT sample
cd LTCallSample-Android-Kotlin/
```
...
With LT SDK, you can build your own customized application with Call function. Refer [DOC](https://loftechs.github.io/LTSDK-Doc)
